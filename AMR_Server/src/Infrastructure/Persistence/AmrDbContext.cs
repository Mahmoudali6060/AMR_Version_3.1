...
namespace AMR_Server.Infrastructure.Persistence
{
    public partial class AmrDbContext : DbContext, IAmrDbContext
    {
        ...
        public virtual DbSet<SP_GetAllMeter_Result> SP_GetAllMeter_Result { get; set; }
        public virtual DbSet<SP_GetAllGateway_Result> SP_GetAllGateway_Result { get; set; }
        public virtual DbSet<SP_GetAllVendorLite_Result> SP_GetAllVendorLite_Result { get; set; }
        public virtual DbSet<SP_GetUserPrivileges_Result> SP_GetUserPrivileges_Result { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SP_GetAllMeter_Result>(entity =>
                {
                    entity.HasNoKey();
                });

            modelBuilder.Entity<SP_GetAllGateway_Result>(entity =>
            {
                entity.HasNoKey();
            });

            modelBuilder.Entity<SP_GetAllVendorLite_Result>(entity =>
            {
                entity.HasNoKey();
            });

            modelBuilder.Entity<SP_GetUserPrivileges_Result>(entity =>
            {
                entity.HasNoKey();
            });
