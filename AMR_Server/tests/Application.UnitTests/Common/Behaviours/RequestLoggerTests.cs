...
namespace AMR_Server.Application.UnitTests.Common.Behaviours
{
    ...
    {
        private readonly Mock<ILogger<GetUserPrivilegesCommand>> _logger;
        ...
        {
            _logger = new Mock<ILogger<GetUserPrivilegesCommand>>();
        ...
        public async Task ShouldCallGetUserNameAsyncOnceIfAuthenticated()
        {
            ...
            await requestLogger.Process(new GetUserPrivilegesCommand { Id = new System.Guid(), UserName = "Admin@123" }, new CancellationToken());
